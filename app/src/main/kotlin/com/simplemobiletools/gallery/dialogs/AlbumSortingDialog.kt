...
import com.simplemobiletools.gallery.activities.OrderAlbumsActivity
import com.simplemobiletools.gallery.activities.SimpleActivity
import com.simplemobiletools.gallery.extensions.config
import kotlinx.android.synthetic.main.dialog_album_sorting.view.*

class AlbumSortingDialog(val activity: SimpleActivity, val isDirectorySorting: Boolean, showFolderCheckbox: Boolean,
    ...
    init {
        view = LayoutInflater.from(activity).inflate(R.layout.dialog_album_sorting, null).apply {
            ...
            album_sorting_custom_sorting.setColorFilter(activity.config.primaryColor)
            custom_sorting_root.setOnClickListener {
                activity.startActivity(Intent(activity, OrderAlbumsActivity::class.java))
                mDialog?.dismiss()
            }
        }
