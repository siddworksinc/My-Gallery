        ...
        if (degrees == 0f) {
            ...
            Glide.with(this)
                ...
                .listener(object : RequestListener<Bitmap> {
                    ...
                    override fun onResourceReady(resource: Bitmap?, model: Any?, target: Target<Bitmap>?, dataSource: DataSource?, isFirstResource: Boolean): Boolean {                                if (isFragmentVisible)
                        addZoomableView()
                        return false
                        }
                    }).into(view.photo_view)
